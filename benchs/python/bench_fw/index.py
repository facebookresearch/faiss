...
import faiss
import numpy as np
from .descriptors import IndexBaseDescriptor

from faiss.contrib.evaluation import (
    knn_intersection_measure,
    OperatingPointsWithRanges,
)
from faiss.contrib.factory_tools import (
    reverse_index_factory,
)
from faiss.contrib.ivf_tools import (
    add_preassigned,
