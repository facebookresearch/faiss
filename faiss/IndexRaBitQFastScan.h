...
struct IndexRaBitQFastScan : IndexFastScan {
    ...
    /// Migrate old-format index: re-layout blocks and copy aux data from
    /// legacy flat_storage into block auxiliary region. Called during
    /// deserialization of old "Irfs" format indexes.
