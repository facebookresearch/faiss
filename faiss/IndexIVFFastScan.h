...
struct IndexIVFFastScan : IndexIVF {
    ...
    /** Compute lookup tables for distance computation
     *
     ...
     * @param query_offset  starting offset for query processing
     */
