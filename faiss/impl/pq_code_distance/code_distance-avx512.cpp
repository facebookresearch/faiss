...
template <>
struct PQCodeDistance<PQDecoder8, SIMDLevel::AVX512F> {
    ...
    void distance_four_codes_avx512(
            // number of subquantizers
            const size_t M,
            // number of bits per quantization index
            const size_t nbits,
...
template struct PQCodeDistance<PQDecoder16, SIMDLevel::AVX512F>;
template struct PQCodeDistance<PQDecoderGeneric, SIMDLevel::AVX512F>;
