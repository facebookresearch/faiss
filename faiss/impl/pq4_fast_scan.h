 ...
 * @param code_stride  optional stride between consecutive codes (0 = use
 * default (M + 1) / 2)
 * @param block_stride  optional stride in bytes between consecutive blocks.
 *                      0 = use default (bbs * nsq / 2). Set to a larger
 *                      value when blocks contain auxiliary data after the
 *                      packed codes.
 */
 ...
 *                      0 = use default (bbs * nsq / 2). Set to a larger
 *                      value when blocks contain auxiliary data after the
 *                      packed codes (e.g., RaBitQ per-vector factors).
 */
 ...
 * @param scaler  scaler to scale the encoded norm
 * @param block_stride  stride in bytes between consecutive blocks.
 *                      0 = use default (32 * nsq / 2). Set to a larger
 *                      value when blocks contain auxiliary data after the
 *                      packed codes (e.g., RaBitQ per-vector factors).
 */
