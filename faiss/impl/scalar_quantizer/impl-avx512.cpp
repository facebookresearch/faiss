...
template <>
struct Codec8bit<SIMDLevel::AVX512F> : Codec8bit<SIMDLevel::NONE> {
...
template <>
struct Codec4bit<SIMDLevel::AVX512F> : Codec4bit<SIMDLevel::NONE> {
    static FAISS_ALWAYS_INLINE simd16float32
    decode_16_components(const uint8_t* code, int i) {
...
template <>
struct Codec6bit<SIMDLevel::AVX512F> : Codec6bit<SIMDLevel::NONE> {
    static FAISS_ALWAYS_INLINE simd16float32
    decode_16_components(const uint8_t* code, int i) {
...
struct QuantizerT<Codec, QScaling::UNIFORM, SIMDLevel::AVX512F>
...
template <class Codec>
struct QuantizerT<Codec, QScaling::NON_UNIFORM, SIMDLevel::AVX512F>
...
template <>
struct QuantizerFP16<SIMDLevel::AVX512F> : QuantizerFP16<SIMDLevel::NONE> {
...
template <>
struct QuantizerBF16<SIMDLevel::AVX512F> : QuantizerBF16<SIMDLevel::NONE> {
...
template <>
struct Quantizer8bitDirect<SIMDLevel::AVX512F>
...
template <>
struct Quantizer8bitDirectSigned<SIMDLevel::AVX512F>
...
template <>
struct SimilarityL2<SIMDLevel::AVX512F> {
    static constexpr SIMDLevel SIMD_LEVEL = SIMDLevel::AVX512F;
...
template <>
struct SimilarityIP<SIMDLevel::AVX512F> {
    static constexpr SIMDLevel SIMD_LEVEL = SIMDLevel::AVX512F;
    static constexpr int simdwidth = 16;
...
struct DCTemplate<Quantizer, Similarity, SIMDLevel::AVX512F>
...
struct DistanceComputerByte<Similarity, SIMDLevel::AVX512F>
        : SQDistanceComputer {
    using Sim = Similarity;
...
template ScalarQuantizer::SQuantizer* select_quantizer_1<SIMDLevel::AVX512F>(
        QuantizerType qtype,
        size_t d,
        const std::vector<float>& trained);

template SQDistanceComputer* select_distance_computer_1<SIMDLevel::AVX512F>(
        MetricType metric_type,
        QuantizerType qtype,
        size_t d,
        const std::vector<float>& trained);

template InvertedListScanner* sel0_InvertedListScanner<SIMDLevel::AVX512F>(
        MetricType mt,
