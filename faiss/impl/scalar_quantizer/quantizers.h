...
struct QuantizerFP16<1> : ScalarQuantizer::SQuantizer {
    ...
    QuantizerFP16(size_t d_in, const std::vector<float>& /* unused */) : d(d_in) {}
...
struct QuantizerBF16<1> : ScalarQuantizer::SQuantizer {
    ...
    QuantizerBF16(size_t d_in, const std::vector<float>& /* unused */) : d(d_in) {}
...
struct Quantizer8bitDirectSigned<1> : ScalarQuantizer::SQuantizer {
    ...
    Quantizer8bitDirectSigned(size_t d_in, const std::vector<float>& /* unused */)
            : d(d_in) {}
