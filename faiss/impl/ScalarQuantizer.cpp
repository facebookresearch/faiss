...
struct Codec8bit {
    ...
    static FAISS_ALWAYS_INLINE simd8uint32 load6(const uint16_t* code16) {
    ...
    decode_8_components(const uint8_t* code, int i) {
        ...
        __m256i i8 = load6((const uint16_t*)(code + (i >> 2) * 3)).i;
        __m256 f8 = _mm256_cvtepi32_ps(i8);
...
struct QuantizerTemplate<Codec, QuantizerTemplateScaling::UNIFORM, 8>
    ...
    reconstruct_8_components(const uint8_t* code, int i) const {
        ...
        return simd8float32(
                fmadd(xi, simd8float32(this->vdiff), simd8float32(this->vmin)));
    }
};
#endif
    template <class Codec>
...
struct QuantizerTemplate<Codec, QuantizerTemplateScaling::NON_UNIFORM, 8>
    ...
    struct QuantizerBF16<1> : ScalarQuantizer::SQuantizer {
        ...
        QuantizerBF16(size_t d, const std::vector<float>& /* unused */)
                : d(d) {}
    ...
    struct QuantizerBF16<16> : QuantizerBF16<1> {
        ...
        reconstruct_16_components(const uint8_t* code, int i) const {
            __m256i code_256i =
                    _mm256_loadu_si256((const __m256i*)(code + 2 * i));
...
struct Quantizer8bitDirect<8> : Quantizer8bitDirect<1> {
    ...
    struct Quantizer8bitDirectSigned<16> : Quantizer8bitDirectSigned<1> {
        ...
        reconstruct_16_components(const uint8_t* code, int i) const {
            ...
            __m512i z16 =
                    _mm512_sub_epi32(y16, c16); // subtract 128 from all lanes
...
struct SimilarityIP<8> {
    ...
    FAISS_ALWAYS_INLINE void add_8_components(simd8float32 x) {
        simd8float32 yiv(yi);
        yi += 8;
        accu8 = fmadd(yiv, x, accu8);
    }

    FAISS_ALWAYS_INLINE void add_8_components_2(
            simd8float32 x1,
            simd8float32 x2) {
        accu8 = fmadd(x1, x2, accu8);
    }
