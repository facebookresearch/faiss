...
//                 accu[q][b][0] += scaler.scale_lo(res0); // handle vectors
//                 0..7 accu[q][b][1] += scaler.scale_hi(res0); // handle
//                 vectors 8..15

//                 simd32uint8 res1 = scaler.lookup(lut, chi);
//                 accu[q][b][2] += scaler.scale_lo(res1); // handle
//                 vectors 16..23 accu[q][b][3] +=
