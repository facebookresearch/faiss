...
template <class ResultHandler, bool use_sel = false>
void exhaustive_inner_product_seq_boundary(
        const float* x,
        const float* y,
        const float lower,
        const float upper,
...
template <class ResultHandler, bool use_sel = false>
void exhaustive_L2sqr_seq_boundary(
        const float* x,
        const float* y,
        const float lower,
        const float upper,
...
template <class ResultHandler>
void exhaustive_inner_product_blas_boundary(
        const float* x,
        const float* y,
        const float lower,
        const float upper,
...
template <class ResultHandler>
void exhaustive_L2sqr_blas_default_impl_boundary(
        const float* x,
        const float* y,
        const float lower,
        const float upper,
...
template <class ResultHandler>
void exhaustive_L2sqr_blas_boundary(
        const float* x,
        const float* y,
        const float lower,
        const float upper,
...
template <>
void exhaustive_L2sqr_blas_boundary<SingleBestResultHandler<CMax<float, int64_t>>>(
        const float* x,
        const float* y,
        const float lower,
        const float upper,
...
template <class ResultHandler>
void knn_L2sqr_select_boundary(
        const float* x,
        const float* y,
        const float lower,
        const float upper,
