...
struct SIMDHistogram {
    ...
    using simd32uint8 = faiss::simd32uint8<SL>;
    using simd16uint16 = faiss::simd16uint16<SL>;
    using simd8uint32 = faiss::simd8uint32<SL>;
...
#endif // defined(COMPILE_SIMD_AVX2) || defined(COMPILE_SIMD_ARM_NEON)
