...
IndexShardsTemplate<IndexT>::IndexShardsTemplate(
        idx_t d_in,
        bool threaded,
        bool successive_ids_in)
        : ThreadedIndex<IndexT>(d_in, threaded), successive_ids(successive_ids_in) {
    sync_d(this);
}
...
IndexShardsTemplate<IndexT>::IndexShardsTemplate(
        bool threaded,
        bool successive_ids_in)
        : ThreadedIndex<IndexT>(threaded), successive_ids(successive_ids_in) {
    sync_d(this);
}
