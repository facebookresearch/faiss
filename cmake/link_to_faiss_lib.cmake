...
function(link_to_faiss_lib target)
  ...
  if(FAISS_OPT_LEVEL STREQUAL "avx512_spr")
    if(NOT WIN32)
      ...
      target_compile_options(${target} PRIVATE $<$<COMPILE_LANGUAGE:CXX>:-mavx2 -mfma -mf16c -mavx512f -mavx512cd -mavx512vl -mavx512dq -mavx512bw -mavx512vpopcntdq -mavx512bitalg -mpopcnt -mavx512vnni -mavx512vbmi -mavx512fp16 -mavx512bf16>)
    else()
      target_compile_options(${target} PRIVATE $<$<COMPILE_LANGUAGE:CXX>:/arch:AVX512>)
    endif()
