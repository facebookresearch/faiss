...
class TestIndexIVFLocalSearchQuantizer(unittest.TestCase):
    ...
    def eval_index_accuracy(self, factory_key):
        # just do a single test, most search functions are already stress tested
        # test_residual.py
        ...
        # in fact the results should be the same for the decoding and the reconstructing versions
